...
public class RecordingSDK {
   ...
   * 
   * After the recording application successfully joins the channel, the SDK triggers the {@link io.agora.recording.RecordingEventHandler.onLocalUserRegistered onLocalUserRegistered} and {@link io.agora.recording.RecordingEventHandler.onJoinChannelSuccess onJoinChannelSuccess} callbacks on the local client.
   * 

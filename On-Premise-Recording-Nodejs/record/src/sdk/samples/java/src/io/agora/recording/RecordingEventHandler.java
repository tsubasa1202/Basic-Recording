...
public interface RecordingEventHandler {
  ...
  /** Occurs when the recording application successfully registers a user account by calling the {@link io.agora.recording.RecordingSDK.createChannelWithUserAccount createChannelWithUserAccount} method. This callback reports the user ID and user account of the recording application.
   * 
   * @param uid The `uid` of the recording application.
